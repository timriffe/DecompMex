...
Figure.heatmap <- function(SubData,Age.group,brksl,brksval){
  useOuterStrips(levelplot(Contribution ~ Year*Statenom|AMLabel+region,                           
                           ...
                           ylim= c(rep(list(c(1,10)),8),rep(list(c(11,21)),8),rep(list(c(22,32)),8)),
                           between = list(x = -8.5),scales=list(x=list(cex=1.3,rot=45,at=seq(1990,2015,5)),
                                                                y=list(relation="free",at = c(rep(list(c(1:32)),28)),
                                                                       labels=list(levels(Data$Statenom)[],NULL,NULL,NULL,NULL,NULL,NULL,NULL,
                                                                                   levels(Data$Statenom)[],NULL,NULL,NULL,NULL,NULL,NULL,NULL,
                                                                                   levels(Data$Statenom)[],NULL,NULL,NULL,NULL,NULL,NULL,NULL),
